...
final List<Color> titulo = [
  ...
  Color(0xFF404040), // Gris muy oscuro
  Color(0xFF404040), // Gris muy oscuro
  Color(0xFF808080), // Gris oscuro
  Color(0xFFFFFFFF), // Blanco (brillante)
  Color(0xFF808080), // Gris oscuro
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Positioned.fill(
              child: Image.asset('lib/assets/alerta-familiar/asd.png', fit: BoxFit.cover,)
          ) :
          ...
          Container(
            child: Padding(
              padding: screenHeight > screenWidth ?EdgeInsets.only(left: screenWidth * 0.07, right: screenWidth * 0.07, top: screenHeight * 0.015, bottom: screenHeight * 0.015) : EdgeInsets.only(left: screenWidth * 0.15, right: screenWidth * 0.15, top: screenHeight * 0.03, bottom: screenHeight * 0.03),
                            ...
                            Expanded( // Para que el contenido ocupe el espacio disponible
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 4),
                                  Text(
                                    "Fecha de nacimiento: 20/07/2003 (21 años a la hora de hacer esta página).",
                                    style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 16,
                                    ),
...
class _InformacionState extends State<Informacion> {
  ...
  // Función para hacer scroll a la posición del ExpansionTile
  void _scrollToExpansionTile(GlobalKey key) {
    // Obtiene la posición del ExpansionTile
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(
                    ...
                    top: 0,
                    left: screenWidth > screenHeight ? screenWidth * 0.05 : screenWidth * 0.02,
                    right: screenWidth > screenHeight ? screenWidth * 0.05 : screenWidth * 0.02),
                child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                      Expanded(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      SizedBox(height: 12),
                                                      Container(
                                                        width: screenWidth > screenHeight ? screenWidth * 0.55 : screenWidth * 0.67,
                                                        child: TextField(
                                                          style: TextStyle(color: Colors.white),
                                                          maxLines: 3,
